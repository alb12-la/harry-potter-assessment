...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_gsap_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./services/gsap.service */
    "./src/app/services/gsap.service.ts");

    var RESULT_MESSAGE_DELAY = 3000;

    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(gsapService) {
      ...
      _createClass(AppComponent, [{
        ...
        key: "answerQuestion",
        value: function answerQuestion(selectedAnswer, question, index) {
          var _this = this;

          //  Dismiss answered question
          this.exitTop("#question-".concat(index)); // Prepare next index

          var nextIndex = index + 1;
          var result; // Determine if answer was correct
          ...
          this.rotateEnterFromBottom(result); // Wait 3 seconds

          setTimeout(function () {
            // Dismiss result
            _this.rotateExitToTop(result); // If more questions remain


            if (_this.questions.length > nextIndex) {
              // Bring in next question
              _this.bringToCenter("#question-".concat(nextIndex));
            } else {
              // Display end screen
              _this.bringToCenter('#ending-screen'); // Display end messages if answers were ALL correct, or ALL wrong


              if (_this.score === 0) {
                _this.summonEndMessage('#snape');
              } else if (_this.score === _this.questions.length) {
                _this.summonEndMessage('#the-gang');
              }
            }
        ...
        key: "rotateExitToTop",
        value: function rotateExitToTop(elementId) {
          var moveUp = {
            y: -1000,
            rotate: 720,
            duration: 1.5,
        ...
        key: "rotateEnterFromBottom",
        value: function rotateEnterFromBottom(elementId) {
          var fromPosition = {
            y: 0,
            top: '110%',
            rotate: 0,
        ...
        key: "exitTop",
        value: function exitTop(elementId) {
          var moveUp = {
            y: -1000,
            duration: 2
          };
        ...
        key: "bringToCenter",
        value: function bringToCenter(elementId) {
          var fromPosition = {
            y: 0,
            top: '150%',
            duration: 1,
        ...
        key: "summonEndMessage",
        value: function summonEndMessage(elementId) {
          var fromPosition = {
            bottom: '-1000px',
            duration: 3
          };
        ...
        key: "dismissEndMessage",
        value: function dismissEndMessage(elementId) {
          var fromPosition = {
            bottom: '0px',
            duration: 3
          };
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_gsap_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./services/gsap.service */
    "./src/app/services/gsap.service.ts");
  ...
  /***/
  function srcAppServicesGsapServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GsapService", function () {
      return GsapService;
    });
    /* harmony import */
    ...
    var GsapService = /*#__PURE__*/function () {
      function GsapService() {
        _classCallCheck(this, GsapService);
      }

      _createClass(GsapService, [{
        key: "to",
        value: function to(element, vars) {
          gsap_all__WEBPACK_IMPORTED_MODULE_2__["gsap"].to(element, vars);
        }
      }, {
        key: "fromTo",
        value: function fromTo(element, fromVars, toVars) {
    ...
    GsapService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], GsapService);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/alb/git/harry-potter-assessment/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
